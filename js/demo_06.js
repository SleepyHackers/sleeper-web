...
addEventListener("load", function() {
	...
	label.innerHTML = "" +
	    ...
	    '<div id="fillbox" style="height:180px; overflow:hidden; margin-bottom:4px;"></div><div id="chatbox" style="border-top: 1px dashed rgb(0, 0, 0); padding-top: 5px;"><div>$ <span id="chat_input"></span></div></div>';
